...
class GenerationLoop(
    ...
    private suspend fun generateInternal(
        ...
        val internalMessages = buildList {
            ...
            // compactOldToolText() additionally shrinks the *text* of tool results that are
            // no longer the recent ones, which is what stops a long agent run's context from
            // growing quadratically as every step replays every earlier tool output.
            addAll(
